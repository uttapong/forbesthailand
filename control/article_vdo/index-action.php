...
if ($ModuleAction == "Datalist") {
	...
	$sql = "SELECT p.*,c.name_".strtolower($_SESSION["LANG"])." as category_name,f.physical_name,u.firstname,u.lastname FROM article_main p";
...
<? }else{ ?>
<?=$source_status[$Row["flag_display"]]?>
<? } ?>
