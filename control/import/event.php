...
<?
	...
	if ($SysFSort=="") $SysFSort="p.event_id";
	...
	*/
	...
	for ($i=0;$i<$CntRecInPage;$i++) {
		...
		$insert["menu_id"] 				= "'MNT12'";	
		
		$insert["cate_id"] 				= "'29'"; // THAILAND
		$insert["cate1_id"] 			= "'29'"; // THAILAND		

		$insert["name_th"] 			= "".SystemCheckInputToDB($Row["event_title"])."";
		$insert["name_en"] 			= "".SystemCheckInputToDB($Row["event_title"])."";
		$insert["abstract_th"] 		= "".SystemCheckInputToDB($Row["event_abstract"])."";
		$insert["abstract_en"] 		= "".SystemCheckInputToDB($Row["event_abstract"])."";	
		
		
		$insert["content_th"] 			= "".SystemCheckInputToDB($Row["event_detail"])."";
		$insert["content_en"] 			= "".SystemCheckInputToDB($Row["event_detail"])."";
		$insert["article_type"] 		= "'".$Row["event_type"]."'";
		...
		$insert["filepic"] 			= "'".$Row['event_image']."'";
		...
		@copy($libraryFolder."/".$Row['event_image'],$storeFolder."/".$Row['event_image']);
		
		$physical_name=$libraryFolder."/".$Row['event_image'];
		
		if ((is_file($physical_name) && file_exists($physical_name) )) {
		
			$resizeObj 	= new ResizeImage($libraryFolder."/".$Row['event_image']);
			$resizeObj->resizeTo(290,290,'maxwidth');
			$resizeObj->saveImage(_SYSTEM_UPLOADS_FOLDER_."/article_thumb/".$Row['event_image']);
		...
		$insert["cstate"] 			= "'".$Row["visited"]."'";
		$insert["order_by"] 			= "'".$Row["event_order"]."'";
