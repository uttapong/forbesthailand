...
class ResizeImage
{
	...
	private function getOptimalCrop($newWidth, $newHeight)
	{
		...
		$optimalHeight = $this->origHeight / $optimalRatio;
		$optimalWidth  = $this->origWidth  / $optimalRatio;
	...
	public function resizeTo( $width, $height, $resizeOption = 'default' )
	{
		switch(strtolower($resizeOption))
		{
			...
			case 'crop':
				...
				$this->resizeWidth = $optionArray['optimalWidth'];
				$this->resizeHeight = $optionArray['optimalHeight'];
			...
			default:
				...
				if( ($this->origHeight <= $height) && ($this->origWidth <= $width) )
		...
		imagealphablending($this->newImage,false);  //GOLF
		imagesavealpha($this->newImage,true);  //GOLF
		
		imagecopyresampled($this->newImage, $this->image, 0, 0, 0, 0, $this->resizeWidth, $this->resizeHeight, $this->origWidth, $this->origHeight);
		if(strtolower($resizeOption)=="crop"){	
