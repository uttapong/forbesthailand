<?php
	...
	$fname_export="newsletter_xport.xls";	
	...
	*/
	...
	$row_no=1;	
	$worksheet->write($row_no,0, iconv('UTF-8','TIS-620',"NEWSLETTER Export"),  $headerRpt);	
	$row_no++;
	...
	$source_head="";
	$source_head[] ="Email";
	$source_head[] = "Order No.";
	$source_head[] = "Barcode";
	$source_head[] = "Customer";
	$source_head[] = "Product Description";
	$source_head[] = "Spot Description";	
	$source_head[] = "Len";

	
	$ic=0;$worksheet->write($row_no, $ic,iconv('UTF-8','TIS-620',"Email"),$header); 
	$ic++;$worksheet->write($row_no, $ic,iconv('UTF-8','TIS-620',"Date"),$header); 
	...
	if($CntRecInPage >0) { 
			...
			for ($i=0;$i<$CntRecInPage;$i++) {
				$Row = $ContentList[$i];
				$row_no=$row_no+1;
				$ic=0;$worksheet->write($row_no, $ic,iconv('UTF-8','TIS-620',$Row["email"]),$cell_style1);
