...
if($SysPMS!="MANAGE"){ 
	...
	$sql = "select count(*) as C  from cover_main where id = '$ModuleDataID' and createby='".$_SESSION['UserID']."'";
...
if($ModuleAction == "AddForm"){
	...
	$sql = "select *  from cover_main where id = '$ModuleDataID'";
...
<?
	...
	for ($i=0;$i<$CntRecFile;$i++) {
		...
		$physical_name=_SYSTEM_UPLOADS_FOLDER_."/cover/".$RowFile["physical_name"];
...
<br>
  ...
  <div class="control-group">
        <label class="control-label request"  for="input_issue_th">* ฉบับที่</label>
        <div class="controls">
        <input type="text" id="input_issue_th" name="input_issue_th"  class="input-xxlarge request" value="<?=$Row["issue_th"]?>">
        </div>
        </div>
        <div class="control-group">
  ...
  <div class="tab-pane" id="content-en">
  		<div class="control-group">
        <label class="control-label request"  for="input_issue_en">* ฉบับที่</label>
        <div class="controls">
        <input type="text" id="input_issue_en" name="input_issue_en"  class="input-xxlarge request" value="<?=$Row["issue_en"]?>">
        </div>
        </div>
          <div class="control-group">
        <label class="control-label request"  for="product_name">* ชื่อ</label>
...
<?
	...
	$sql = "SELECT p.*,c.name as category_name FROM cover_main p";
