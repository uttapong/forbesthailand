...
<?
		...
		$insert["name_en"] 				= "'".trim($_REQUEST['category_name_en'])."'";
		$insert["name_th"] 				= "'".trim($_REQUEST['category_name_th'])."'";
...
<? 
	...
	$update="";
	$update[] = "name_en 		= '".trim($_REQUEST['category_name_en'])."'";
	$update[] = "name_th		= '".trim($_REQUEST['category_name_th'])."'";
