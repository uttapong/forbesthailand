...
<br>
  ...
  <div class="tab-pane" id="content-th">
        ...
        <div class="controls">
        <textarea id="input_name_th" name="input_name_th"  class="input-xxlarge" rows="4"><?=$Row["name_th"]?></textarea>
        </div>
        </div>
        ...
        <div class="control-group">
        <label class="control-label request"  for="input_value_th">* VALUE( $ )</label>
        <div class="controls">
        <input type="text" id="input_value_th" name="input_value_th" class="input-xxlarge request " value="<?=$Row["value_th"]?>" >
        </div>
        </div>
        
        <div class="control-group">
        <label class="control-label request"  for="input_business_th">* BUSINESS</label>
        <div class="controls">
        <input type="text" id="input_business_th" name="input_business_th" class="input-xxlarge request " value="<?=$Row["business_th"]?>" >
        </div>
        </div>
  ...
  <div class="tab-pane" id="content-en">
        ...
        <textarea id="input_name_en" name="input_name_en"  class="input-xxlarge" rows="4"><?=$Row["name_en"]?></textarea>
          ...
          <div class="control-group">
        <label class="control-label request"  for="input_value_en">* VALUE( $ )</label>
        <div class="controls">
        <input type="text" id="input_value_en" name="input_value_en" class="input-xxlarge request " value="<?=$Row["value_en"]?>" >
        </div>
        </div>
        
        <div class="control-group">
        <label class="control-label request"  for="input_business_en">* BUSINESS</label>
        <div class="controls">
        <input type="text" id="input_business_en" name="input_business_en" class="input-xxlarge request " value="<?=$Row["business_en"]?>" >
        </div>
        </div>
...
<div class="block-content">
   ...
   <li id="<?=$Row["id"]?>" rel="<?=$Row["order_by"]?>">
            	<div class="box">
                    <div class="ft-left" >
                    <div style=" width:40px; display:inline-block; float:left; border:1px solid #ccc; margin-top:4px; margin-right:10px;">
                    <img src="<?=$physical_name?>" style="width:100%" > 
                    </div>
