...
function SystemLogin(url) {
	...
	MyGlassBox.show();
	MyGlassBox.setText(400,200,getHTML('../authen/authentication-prompt.php?PromptAction=PleaseWait'));
	$.ajax({
			...
			if ( resp.error== "true") {
					...
					//MyGlassBox.setText(400,200,getHTML('../authen/authentication-prompt.php?PromptAction=LoginComplete'));
					
					MyGlassBox.setText(400,400,getHTML('../authen/authentication-prompt.php?PromptAction=SelectSiteMapping'));
					...
					*/
					...
					MyGlassBox.setText(400,200,getHTML('../authen/authentication-prompt.php?PromptAction=LoginFail'));
				}
			}
   });
}
...
function sysListTextSearch(){ 
	...
	$('#SysTextSearch').val($('input.input_search').val());
	$('#SysPage').val(1);
	sysListLoadDatalist($('#mySearch').serialize());
}
