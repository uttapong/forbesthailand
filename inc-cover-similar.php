	...
	$sql.= " WHERE 1=1 and p.flag_display='Y' and  p.flag_approved='Y'  and p.id<>'".$did."'";		
	if($cate_lel1>0){
	...
	?>
					...
					$_title_module=$_source_title[$mid];
					$_color_module=$_source_color[$mid];
					$_url_module=$_source_url[$mid];	
			?>
                      <div class="item col-xs-12 col-sm-4 mbc">
                        <div class="block">
                              ...
                              <div class="article-sm">
                                  <a class="cover" href="<?=$_url_module?>?did=<?=$Row["id"]?>"><img src="<?=$physical_name?>" class="img-responsive align-center"></a>
                                  <p class="topic">
                                     <?=$topic?>
                                      </p>
