...
<?  $mgroup="MOST_POPULAR_MAIN";  	$txt_search=$_REQUEST["s"]; ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
           ...
           <div class="container">
               <div class="row">
                  <div class="col-xs-12 col-sm-8 mb">
                    ...
                    <div class="block"> 
                    <div class="tab-block search" >
                    <span> SEARCH RESULT</span>
                    </div>
                        <div class="article search">     
                        <span>คำที่ใช้ค้นหา : </span>
                        <form  method="get" id="frmsearch"  action="search.php" >
                        <input type="text" name="s" id="s" class="input-search search"  required placeholder="SEARCH" value="<?=$txt_search?>">
	...
	?>
                           ...
                           <div class="col-xs-12 mbc">
                               <div class="block">
                                   ...
                                   <div class="clearfix"></div>    
                                   <div class="article">
                                    <?   if($ContentList[0]["menu_id"]=="MNT14"){  ?>   
                                       <div class="col-xs-12">
                                          <div class="row">
...
<script type="text/javascript">
  $(function () {			  
	...
	$("#loadMore").on('click', function (e) {
		e.preventDefault();	
		var Vars="ModuleAction=getMoreContent&mid=<?=$mid?>&s=<?=$txt_search?>&page="+$(this).attr('page');	
