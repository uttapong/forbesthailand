...
<?  
$mgroup="ASIANBIZ_MAIN";  
$did=$_REQUEST["did"];
$url_share=_SYSTEM_HOST_NAME_."/".strtolower($_SESSION['FRONT_LANG'])."/asianbiz-detail.php?did=".$did;
               ...
               <div class="row">
                   ...
                   <div class="col-xs-12 col-sm-4">
                      <div class="row">
                           ...
                           <? $mid="MNT06"; include('./inc-popular-top.php');	?>      
                      </div>
                   </div>
                   <div class="clearfix"></div>
                   <?	$mid="MNT06"; include('./inc-similar.php');	?>
