...
$mgroup="PEOPLE_MAIN";  
$did=$_REQUEST["did"];
$url_share=_SYSTEM_HOST_NAME_."/".strtolower($_SESSION['FRONT_LANG'])."/people-detail.php?did=".$did;
       ...
       <section class="content">
           <div class="container">
               <div class="row">
                   <div class="col-xs-12 col-sm-8 mb">
                       <div class="row">
                           <div class="col-xs-12 mbc">
                               <div class="block">
                                   <div class="tab-block">
                                       <span>people <?=$source_navi["navi"];?></span>
                                   </div>
                   ...
                   <div class="clearfix"></div>
                   <?	$mid="MNT03"; include('./inc-similar.php');	?>
