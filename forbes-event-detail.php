...
<?  
$mgroup="FORBES_EVENT_MAIN";  
$did=$_REQUEST["did"];
$url_share=_SYSTEM_HOST_NAME_."/".strtolower($_SESSION['FRONT_LANG'])."/forbes-event-detail.php?did=".$did;
               ...
               <div class="row">
                   <div class="col-xs-12 col-sm-8 mb">
                       <div class="row">
                           <div class="col-xs-12 mbc">
                               <div class="block">
                                   <div class="tab-block">
                                       <span>forbes event <?=$source_navi["navi"];?></span>
                                   </div>
                                   <div class="cat-brown"></div>
                                   <div class="clearfix"></div>
                   ...
                   <div class="col-xs-12 col-sm-4">
                      <div class="row">
                           ...
                           <? $mid="MNT12";include('./inc-popular-top.php');	?>      
                      </div>
                   </div>
                   <div class="clearfix"></div>
                   <?	$mid="MNT12"; include('./inc-similar.php');	?>
