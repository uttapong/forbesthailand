	...
	?>
                           ...
                           <div class="col-xs-12">
                               <div class="block mbc">
                                   ...
                                   <div class="cat-green"></div>
                                   <div class="clearfix"></div>    
                                   <div class="article">
                                       <a href="entrepreneurs-detail.php?did=<?=$ContentList[0]["id"]?>">
                                   ...
                                   <div class="clearfix"></div>
                                   <div class="see-all">
                                        <a href="entrepreneurs-detail.php?did=<?=$ContentList[0]["id"]?>"><?=_Detail_More_?> <i class="icon-arrow"></i></a>
                                   </div>
                               </div>
                           </div>
