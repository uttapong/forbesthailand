...
<html lang="en">
 ...
 <?
	...
	$mid="MNT13";
		...
		$sql = "SELECT p.id,p.filepic,p.cate2_name,p.content_th,p.content_en,p.cate_id,p.name_".strtolower($_SESSION['FRONT_LANG'])." as name_content  FROM (SELECT pp.*,cc.name_".strtolower($_SESSION['FRONT_LANG'])." as cate2_name FROM article_main pp ";
	...
	?>
                           ...
                           <div class="col-xs-12">
                               <div class="block">
                                   ...
                                   <div class="clearfix"></div>    
                                   <div class="article">
                                       <a href="forbes_life_thailand-detail.php?did=<?=$ContentList[0]["id"]?>">
                                   ...
                                   <div class="clearfix"></div>
                                   <div class="see-all">
                                        <a href="forbes_life_thailand.php?cid=<?=$ContentList[0]["cate_id"]?>">see all <i class="icon-arrow"></i></a>
                                   </div>
                               </div>
                           </div>
	...
	for ($i=1;$i<$CntRecContentList;$i++) {
		...
		$_url_module="forbes_life_thailand-detail.php";
		$_url_seeall="forbes_life_thailand.php?cid=".$Row["cate_id"];
