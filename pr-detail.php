...
$mgroup="PR_NEWS_MAIN";  
$did=$_REQUEST["did"];
$url_share=_SYSTEM_HOST_NAME_."/".strtolower($_SESSION['FRONT_LANG'])."/pr-detail.php?did=".$did;
               ...
               <div class="row">
                   ...
                   <div class="col-xs-12 col-sm-4">
                      <div class="row">
                           ...
                           <? $mid="MNT15";include('./inc-popular-top.php');	?>      
                      </div>
                   </div>
                   <div class="clearfix"></div>
                   <?	$mid="MNT15"; include('./inc-similar.php');	?>
